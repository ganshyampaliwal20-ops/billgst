...
const cssToInject = `
                ...
                .ns-sheet {
                    background:var(--paper); width:100%; max-width:420px; border-radius:24px 24px 0 0; padding:0 0 24px; position:relative; box-shadow:0 30px 60px -20px rgba(14,21,38,0.35); transform:translateY(0); animation:slideUp 0.3s ease; max-height:90vh; overflow-y:auto; font-family:'Inter',sans-serif;
                }
                @media (min-width: 640px) { .ns-sheet { border-radius:24px; animation:scaleUp 0.2s ease; max-height:85vh; } }
