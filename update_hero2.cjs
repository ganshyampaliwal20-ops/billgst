...
const replacements = [
    { find: find1, replace: replace1, name: "hero-actions wrapper" },
    { find: find2, replace: replace2, name: "signup button" },
    { find: find3, replace: replace3, name: "login button" },
    { find: find4, replace: replace4, name: "play store button" },
    { find: find5, replace: replace5, name: "trust signals" },
    { find: find6, replace: replace6, name: "db-wrap" }
];
