...
export const generateInvoicePDF = (invoice, businessDetails) => {
    ...
    // Totals Section - Aggressive fix to prevent cutoff
    const rightColX = 115;  // Label position - moved significantly left
    const valueX = 180;     // Value position - safe margin from edge
