...
let content1 = fs.readFileSync(path1, 'utf8').replace(/\r\n/g, '\n');
...
if (content1.includes(target1)) {
    ...
    content1 = content1.replace('import { Html5QrcodeScanner } from "html5-qrcode";', 'import { Html5Qrcode, Html5QrcodeScanner } from "html5-qrcode";');
...
let content2 = fs.readFileSync(path2, 'utf8').replace(/\r\n/g, '\n');

const target2 = `            let scanner: Html5QrcodeScanner | null = null;
...
const replacement2 = `            let scanner: Html5Qrcode | null = null;
...
if (content2.includes(target2)) {
    ...
    content2 = content2.replace('import { Html5QrcodeScanner } from "html5-qrcode";', 'import { Html5Qrcode, Html5QrcodeScanner } from "html5-qrcode";');
