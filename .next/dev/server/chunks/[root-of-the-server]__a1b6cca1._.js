...
async function POST(request) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id FROM users WHERE email = $1', [
            email
        ]);
        ...
        // Create user
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('INSERT INTO users (name, email, password, role) VALUES ($1, $2, $3, $4) RETURNING id, name, email, role', [
            name,
            email,
            hashedPassword,
            'USER'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1b6cca1._.js.map