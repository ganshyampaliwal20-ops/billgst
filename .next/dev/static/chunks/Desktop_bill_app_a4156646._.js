...
function NewInvoicePage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (outOfStockItems.length > 0) {
            const errorMessage = outOfStockItems.map((item)=>`${item.name}: ${item.requested} requested but only ${item.available} available`).join('\n');
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Stock not available:\n${errorMessage}`, {
                duration: 5000
            });
            return;
        }
        ...
        try {
            ...
            const { calculateInvoiceTotal } = await __turbopack_context__.A("[project]/Desktop/bill/lib/gst-calculator.js [app-client] (ecmascript, async loader)");
            ...
            if (result?.success || result?.id) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Failed: ${result.error}`);
            } else {
                console.error('Save Invoice Failed with Unknown Result:', result);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Failed: ${JSON.stringify(result)}`);
            }
        } catch (error) {
            console.error('Submission Error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Something went wrong. Please try again.');
        } finally{
...
_s(NewInvoicePage, "W1Medyy6fbU7iDH2HwUBte/vutQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=Desktop_bill_app_a4156646._.js.map