...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/bill/node_modules/qrcode/lib/browser.js [app-client] (ecmascript)");
...
const generateInvoicePDF = async (invoice, businessDetailsArg, autoSave = true)=>{
    try {
        ...
        doc.setFontSize(14);
        doc.setFont('helvetica', 'bold');
        const docTitle = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOC_LABELS"][invoice.type] || 'TAX INVOICE';
        ...
        const words = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$gst$2d$calculator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numberToWords"])(Math.round(Number(invoice.total_amount) || 0));
        doc.setFont('helvetica', 'bold');
        ...
        if (businessDetails.upi_id && invoice.total_amount > 0) {
            try {
                ...
                const qrDataUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].toDataURL(upiLink, {
                    margin: 0
                });
                const qrSize = 25;
        ...
        if (autoSave && ("TURBOPACK compile-time value", "object") !== 'undefined') {
        ...
        try {
            const errDoc = new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]();
...
function InvoicesPage() {
    ...
    const [qrCodeUrl, setQrCodeUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InvoicesPage.useEffect": ()=>{
            if (selectedInvoice && businessProfile.upi_id && selectedInvoice.total_amount > 0) {
                ...
                __turbopack_context__.A("[project]/Desktop/bill/node_modules/qrcode/lib/browser.js [app-client] (ecmascript, async loader)").then({
                    "InvoicesPage.useEffect": (QRCode)=>{
                        QRCode.toDataURL(upiLink, {
                            margin: 1
                        }).then({
                            "InvoicesPage.useEffect": (url)=>setQrCodeUrl(url)
                        }["InvoicesPage.useEffect"]).catch({
                            "InvoicesPage.useEffect": (err)=>console.error('QR Gen Error:', err)
                        }["InvoicesPage.useEffect"]);
                    }
                }["InvoicesPage.useEffect"]);
            } else {
    ...
    const handleShareWhatsApp = async (invoice)=>{
        ...
        let doc = null;
        try {
            doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$pdf$2d$generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInvoicePDF"])(invoice, businessProfile, false);
            ...
            if (doc) {
                doc.save(fileName);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('PDF Downloaded! Please attach file in WhatsApp', {
                    duration: 5000,
                    icon: '📎'
                });
            }
    ...
    const handleShareMore = async (invoice)=>{
        if (!invoice) return;
        try {
            const doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$pdf$2d$generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInvoicePDF"])(invoice, businessProfile, false);
            if (!doc) throw new Error('PDF Generation Failed');
            const pdfBlob = doc.output('blob');
            const fileName = `Invoice-${invoice.invoice_number || 'Bill'}.pdf`;
            const file = new File([
            ...
            if (navigator.share) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Share not supported. PDF downloaded.');
            }
        } catch (e) {
            console.error('Share error:', e);
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Sharing failed');
        }
    };
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$lib$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOC_LABELS"][invoice.type] || 'Tax Invoice'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/Desktop/bill/app/dashboard/invoices/page.tsx",
                                                                    lineNumber: 273,
                                                                    columnNumber: 53
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                qrCodeUrl && selectedInvoice.status !== 'PAID' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bill$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(InvoicesPage, "MWooFWrRPPNIwXSteVLIGx85tOs=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_bill_59c9941a._.js.map