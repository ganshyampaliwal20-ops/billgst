            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8 pt-24">
                <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12">
                    ...
                    <div className="space-y-6 text-gray-700">
                        <section>
                            <p className="text-sm text-gray-500 mb-6" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                                <strong>Last Updated:</strong> January 11, 2026
                            </p>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '10px' }}>1. Information We Collect</h2>

                            <h3 className="text-xl font-medium text-gray-800 mb-3" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>1.1 Information You Provide</h3>
                            <ul className="list-disc pl-6 mb-4 space-y-2" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                            ...
                            <h3 className="text-xl font-medium text-gray-800 mb-3" style={{ paddingLeft: '8px', paddingRight: '8px' }}>1.2 Automatically Collected Information</h3>
                            <ul className="list-disc pl-6 mb-4 space-y-2" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>2. How We Use Your Information</h2>
                            <p className="mb-3" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>We use the collected information for:</p>
                            <ul className="list-disc pl-6 mb-4 space-y-2" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>3. Data Storage and Security</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                                We implement industry-standard security measures to protect your data:
                            </p>
                            <ul className="list-disc pl-6 mb-4 space-y-2" style={{ paddingLeft: '8px', paddingRight: '8px', padding: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>4. Data Sharing and Disclosure</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', padding: '8px' }}>5. Your Data Rights</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', paddingTop: '8px', padding: '8px' }}>6. Cookies and Tracking</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', padding: '8px' }}>7. Third-Party Services</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', padding: '8px' }}>8. Children&apos;s Privacy</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px', padding: '8px' }}>9. Data Retention</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>10. International Data Transfers</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>11. Updates to This Policy</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>12. Contact Us</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                                If you have questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us:
                            </p>
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section className="mt-8 pt-6 border-t border-gray-200" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>13. Consent</h2>
                            <p className="mb-4" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                        ...
                        <section className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                            <h3 className="text-lg font-semibold text-gray-900 mb-3" style={{ paddingLeft: '8px', paddingRight: '8px' }}>Your Privacy Matters</h3>
                            <p className="text-gray-700" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
