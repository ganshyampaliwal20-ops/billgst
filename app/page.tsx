...
export default function LandingPage() {
    ...
    const doLogin = () => {
        // Linked to existing login logic
        router.push('/login');
    };

    const doSignup = () => {
        // Linked to existing registration logic
        ...
        <div className="landing-body">
                ...
                <div className="foot-in">
                    <div className="foot-top">
                        <div className="f-brand">
                            ...
                            <p>India का #1 billing & GST software। हर दुकान के लिए, हर भाषा में।</p>
                        </div>
                        ...
                        <div className="f-col"><h5>Support</h5><ul><li><a href="#">Help</a></li><li><a href="#">Privacy</a></li></ul></div>
                    </div>
                    <div className="foot-btm">
                        <span>© 2026 BillGST · All rights reserved</span>
            ...
            {isLoginOpen && (
                <div className="m-bg on" onClick={(e) => e.target === e.currentTarget && closeM('login')}>
                    <div className="m-box">
                        <button className="m-x" onClick={() => closeM('login')}>✕</button>
                        <h2>Welcome back 👋</h2>
                        <p className="ms">Login to your BillGST account</p>
                        <div className="fg"><label>Mobile Number</label><input type="tel" placeholder="10 digit mobile" maxLength={10} /></div>
                        <div className="fg"><label>Password</label><input type="password" placeholder="Enter password" /></div>
                        <button className="btn-mf" onClick={doLogin}>Login →</button>
            ...
            {isSignupOpen && (
                <div className="m-bg on" onClick={(e) => e.target === e.currentTarget && closeM('signup')}>
                    <div className="m-box">
                        <button className="m-x" onClick={() => closeM('signup')}>✕</button>
                        <h2>Account बनाएं 🚀</h2>
                        <p className="ms">No credit card · Setup in 2 minutes</p>
                        <div className="fg"><label>आपका नाम</label><input type="text" placeholder="Ramesh Kumar" /></div>
                        <div className="fg"><label>Mobile Number</label><input type="tel" placeholder="10 digit mobile" maxLength={10} /></div>
                        <button className="btn-mf" onClick={doSignup}>मुफ्त Account बनाएं →</button>
