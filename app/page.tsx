...
import { FaFileInvoice, FaChartLine, FaCheckCircle, FaRocket } from 'react-icons/fa';
      ...
      <header className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
        <nav className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/login"
              className="px-4 py-2 text-indigo-100 hover:text-white font-medium transition"
            >
              Login
            </Link>
            <Link
              href="/dashboard"
              className="px-5 py-2.5 bg-white text-indigo-600 font-bold rounded-lg shadow-lg hover:bg-gray-50 transition"
            >
              Dashboard
            </Link>
          </div>
