  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden pb-20">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-10 space-y-8">
        ...
        {/* Analytics Overview Section Bar */}
        <div className="bg-gradient-to-r from-violet-600 via-fuchsia-500 to-rose-500 rounded-3xl p-6 md:p-8 text-white shadow-2xl relative overflow-hidden group text-center">
          <h3 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter leading-none mb-2">{t.analyticsOverview}</h3>
          ...
          <div className="flex gap-4 max-w-lg mx-auto">
            {[
              ...
              <button
                ...
                className={`flex-1 py-4 rounded-[25px] font-black text-xs md:text-sm uppercase italic transition-all ${period === item.key
