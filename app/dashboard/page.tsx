          ...
          `}} />
            ...
            <div className="content">
                ...
                <div className="follow-grid">
                    <a className="f-card fc-ig" href="https://www.instagram.com/billgst" target="_blank" rel="noopener">
                        ...
                        <div className="fc-sub">@billgst<br/>Tips & reels</div>
                    </a>

                    <a className="f-card fc-fb" href="https://www.facebook.com/billgst" target="_blank" rel="noopener">
