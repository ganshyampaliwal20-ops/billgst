...
export default function InvoiceViewer() {
    ...
    const upiLink = b?.business_upi_id ? `upi://pay?pa=${b.business_upi_id}&pn=${encodeURIComponent(b.business_name || 'Business')}&am=${invoice.total_amount}&tn=${invoice.invoice_number}` : '#';
